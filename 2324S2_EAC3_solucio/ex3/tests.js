...
const { Producte, Botiga, ProducteAlimentari, ProducteElectronic } = require('./ex3'); 
...
function testComprovarCaducitat() {
    ...
    if (producte.comprovarCaducitat() === true) {
        console.log('Test "Comprovar si un producte alimentari està caducat": passat.');
    } else {
        console.error('Test "Comprovar si un producte alimentari està caducat": fallat.');
    }
}
...
function testComprovarNoCaducitat() {
    ...
    const botiga = new Botiga();
    const producte = new ProducteAlimentari('Iogurt', 1.5, 10, dema);
    botiga.afegirProducte(producte);

    if (producte.comprovarCaducitat() === false) {
        console.log('Test "Comprovar si un producte alimentari no està caducat": passat.');
    } else {
        console.error('Test "Comprovar si un producte alimentari no està caducat": fallat.');
    }
}
...
function testCalcularPreuDescompte() {
    ...
    if (producte.calcularPreuDescompte() === 900) {
        console.log('Test "Calcular preu descomptat per a un producte amb garantia": passat.');
    } else {
        console.error('Test "Calcular preu descomptat per a un producte amb garantia": fallat.');
    }
}
...
function testSenseDescompte() {
    ...
    if (producte.calcularPreuDescompte() === 500) {
        console.log('Test "No aplicar descompte per a un producte sense garantia": passat.');
    } else {
        console.error('Test "No aplicar descompte per a un producte sense garantia": fallat.');
    }
}
